...
from src.domain.value_objects.moedas import Moeda


def test_create():
    obj_1 = Moeda()
    obj_2 = Moeda(2.58, TiposDeMoedas.USD)
    obj_3 = Moeda(67587.98, TiposDeMoedas.EUR)
    obj_4 = Moeda(5478.00, TiposDeMoedas("Dólar Americano"))
    obj_5 = Moeda(12547892.58, TiposDeMoedas["BRL"])
