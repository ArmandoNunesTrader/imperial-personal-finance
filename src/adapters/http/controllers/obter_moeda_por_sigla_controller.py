...
# -*-coding:utf-8 -*-
"""
@File    :   obter_moeda_por_sigla_controller.py
...
"""
    ============================================================================
        Controller do caso de uso Obter Moeda por Sigla
    ============================================================================
"""
...
class ObterMoedaPorSiglaController(ControllerInterface):
    def __init__(self, use_case: Type[ObterMoedaPorSigla]) -> None:
