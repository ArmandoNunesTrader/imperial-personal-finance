...
A idéia deste aplicativo é ter algum produto prático que materialize a minha evolução no aprofundamento do
aprendizado da linguagem **Python** e que sirva de material de pesquisa aos que estão iniciando ou mesmo, querendo uma outra perspectiva prática da aplicação dos conceitos de ***Clean Architecture*** e ***DDD***.
